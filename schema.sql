       ...
       BEGIN
            ...
            START TRANSACTION;
                ...
                IF @setmatch + 1 = 2 THEN
                    SET @owner = (SELECT users.id FROM users INNER JOIN offert ON users.id = offert.owner_id WHERE offert.id = id_offert1);
                    ...
                    DELETE FROM liked_Offert WHERE id_user = id_user_inserted AND id_offert = id_offert1;
